...
{
    public partial class CreateCalisthenics : Form
    {
        public CreateCalisthenics()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (MySqlConnection connection = new MySqlConnection(connectionString))
                {
                    ...
                    string sessionCheckQuery = "SELECT COUNT(*) FROM `calisthenics class` WHERE SessionID = @SessionID";
                    ...
                    string trainerCheckQuery = "SELECT COUNT(*) FROM `calisthenics class` WHERE TrainerID = @TrainerID AND Date = @Date AND Time = @Time";
                    ...
                    foreach (string memberId in memberIds)
                    {
                        string memberCheckQuery = "SELECT COUNT(*) FROM `calisthenics class` " +
                    ...
                    string insertQuery = "INSERT INTO `calisthenics class` (SessionID, Date, Time, TrainerID, MemberID1, MemberID2, MemberID3, MemberID4) " +
                    ...
                    using (MySqlCommand insertCmd = new MySqlCommand(insertQuery, connection))
                    {
                        ...
                        MessageBox.Show("Calisthenics class session successfully added!", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
