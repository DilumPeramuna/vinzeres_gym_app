...
{
    public partial class CreateCrossfit : Form
    {
        public CreateCrossfit()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (MySqlConnection connection = new MySqlConnection(connectionString))
                {
                    ...
                    string sessionCheckQuery = "SELECT COUNT(*) FROM `crossfit class` WHERE SessionID = @SessionID";
                    ...
                    string trainerCheckQuery = "SELECT COUNT(*) FROM `crossfit class` WHERE TrainerID = @TrainerID AND Date = @Date AND Time = @Time";
                    ...
                    foreach (string memberId in memberIds)
                    {
                        string memberCheckQuery = "SELECT COUNT(*) FROM `crossfit class` " +
                    ...
                    string insertQuery = "INSERT INTO `crossfit class` (SessionID, Date, Time, TrainerID, MemberID1, MemberID2, MemberID3, MemberID4) " +
                    ...
                    using (MySqlCommand insertCmd = new MySqlCommand(insertQuery, connection))
                    {
                        ...
                        MessageBox.Show("CrossFit class session successfully added!", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
