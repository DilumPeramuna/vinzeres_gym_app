...
{
    public partial class CreatePilates : Form
    {
        public CreatePilates()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (MySqlConnection connection = new MySqlConnection(connectionString))
                {
                    ...
                    string sessionCheckQuery = "SELECT COUNT(*) FROM `pilates class` WHERE SessionID = @SessionID";
                    ...
                    string trainerCheckQuery = "SELECT COUNT(*) FROM `pilates class` WHERE TrainerID = @TrainerID AND Date = @Date AND Time = @Time";
                    ...
                    foreach (string memberId in memberIds)
                    {
                        string memberCheckQuery = "SELECT COUNT(*) FROM `pilates class` " +
                    ...
                    string insertQuery = "INSERT INTO `pilates class` (SessionID, Date, Time, TrainerID, MemberID1, MemberID2, MemberID3, MemberID4) " +
                    ...
                    using (MySqlCommand insertCmd = new MySqlCommand(insertQuery, connection))
                    {
                        ...
                        MessageBox.Show("Pilates class session successfully added!", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
