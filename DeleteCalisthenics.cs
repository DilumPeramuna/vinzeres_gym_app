...
{
    public partial class DeleteCalisthenics : Form
    {
        public DeleteCalisthenics()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (MySqlConnection connection = new MySqlConnection(connectionString))
                {
                    ...
                    string checkQuery = "SELECT COUNT(*) FROM `calisthenics class` WHERE SessionID = @SessionID";
                    ...
                    // Delete the session
                    string deleteQuery = "DELETE FROM `calisthenics class` WHERE SessionID = @SessionID";
