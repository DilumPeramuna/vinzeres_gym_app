...
{
    public partial class DeleteYoga : Form
    {
        public DeleteYoga()
        {
            InitializeComponent();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (MySqlConnection connection = new MySqlConnection(connectionString))
                {
                    ...
                    string checkQuery = "SELECT COUNT(*) FROM `yoga class` WHERE SessionID = @SessionID";
                    ...
                    // Delete the session
                    string deleteQuery = "DELETE FROM `yoga class` WHERE SessionID = @SessionID";
