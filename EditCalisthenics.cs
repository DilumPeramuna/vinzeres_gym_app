...
{
    public partial class EditCalisthenics : Form
    {
        public EditCalisthenics()
        {
            InitializeComponent();
        }
        ...
        private void EditCalisthenics_Load(object sender, EventArgs e)
        {
        ...
        {
            string query = "SELECT COUNT(*) FROM `calisthenics class` WHERE SessionId = @SessionId AND TrainerId = @TrainerId";
            using (MySqlCommand cmd = new MySqlCommand(query, conn, transaction))
            {
                cmd.Parameters.AddWithValue("@SessionId", sessionId);
                cmd.Parameters.AddWithValue("@TrainerId", trainerId);
        ...
        {
            string query = "UPDATE `calisthenics class` SET TrainerId = NULL WHERE SessionId = @SessionId AND TrainerId = @TrainerId";
            using (MySqlCommand cmd = new MySqlCommand(query, conn, transaction))
            {
                cmd.Parameters.AddWithValue("@SessionId", sessionId);
                cmd.Parameters.AddWithValue("@TrainerId", trainerId);
        ...
        {
            string query = "UPDATE `calisthenics class` SET TrainerId = @TrainerId WHERE SessionId = @SessionId";
            using (MySqlCommand cmd = new MySqlCommand(query, conn, transaction))
            {
                cmd.Parameters.AddWithValue("@SessionId", sessionId);
                cmd.Parameters.AddWithValue("@TrainerId", trainerId);
