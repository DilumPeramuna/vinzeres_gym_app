...
{
    public partial class EditYoga : Form
    {
        public EditYoga()
        {
            InitializeComponent();
        ...
        {
            string query = "SELECT COUNT(*) FROM `yoga class` WHERE SessionId = @SessionId AND TrainerId = @TrainerId";
            using (MySqlCommand cmd = new MySqlCommand(query, conn, transaction))
            {
                cmd.Parameters.AddWithValue("@SessionId", sessionId);
                cmd.Parameters.AddWithValue("@TrainerId", trainerId);
        ...
        {
            string query = "UPDATE `yoga class` SET TrainerId = NULL WHERE SessionId = @SessionId AND TrainerId = @TrainerId";
            using (MySqlCommand cmd = new MySqlCommand(query, conn, transaction))
            {
                cmd.Parameters.AddWithValue("@SessionId", sessionId);
                cmd.Parameters.AddWithValue("@TrainerId", trainerId);
        ...
        {
            string query = "UPDATE `yoga class` SET TrainerId = @TrainerId WHERE SessionId = @SessionId";
            using (MySqlCommand cmd = new MySqlCommand(query, conn, transaction))
            {
                cmd.Parameters.AddWithValue("@SessionId", sessionId);
                cmd.Parameters.AddWithValue("@TrainerId", trainerId);
